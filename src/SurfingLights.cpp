...
void SurfingLights::setupParameters() {
	...
	pointLightPosition.set("p Pos", glm::vec3(),
		glm::vec3(-SURFING__SCENE_SIZE_UNIT), glm::vec3(SURFING__SCENE_SIZE_UNIT));
	...
	spotLightPosition.set("s Pos", glm::vec3(),
		glm::vec3(-SURFING__SCENE_SIZE_UNIT), glm::vec3(SURFING__SCENE_SIZE_UNIT));
